package com.appdev.fragmentnavigation;
...
public class FragNavController {
     ...
     * @param transactionOptions Transaction options to be displayed
     */
    public void pushFragment(@Nullable Fragment fragment, @Nullable FragNavTransactionOptions transactionOptions, boolean detach) {
     ...
     * @param fragment The fragment that is to be pushed
     */
    public void pushFragment(@Nullable Fragment fragment, boolean detach) {
        pushFragment(fragment, null, detach);
    }
